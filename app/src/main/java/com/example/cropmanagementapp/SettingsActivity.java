...
/**
 * Settings screen reached from the hamburger icon on the dashboard.
 * Holds the actions that used to live in the hamburger popup menu:
 * generating/sharing/printing the farm report, and logging out.
 */
